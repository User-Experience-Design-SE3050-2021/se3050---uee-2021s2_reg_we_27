...
List<Product> productsList = [
  Product(name: "Burger", price: 300.00, rating: 4.2, description: "Chicken koththu with spicy chiken greavy", wishList: true, image: "burger.jpg"),
  Product(name: "Bites", price: 320.00, rating: 4.2, description: "Crispy Chiken", wishList: true, image: "chiken.jpg"),
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: RichText(text: TextSpan(children: [
                          TextSpan(text: "${productsList[index].name}\n",
                      ...
                      Padding(
                        ...
                        child: RichText(text: TextSpan(children: [
                          TextSpan(text: "\R\S ${productsList[index].price}\n",
