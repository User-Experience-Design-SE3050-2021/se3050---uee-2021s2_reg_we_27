...
class _ShoppingBagState extends State<ShoppingBag> {
 ...
 // Product product = Product(name: "Cerials", price: 5.99, rating: 4.2, description: "GoodFoods", wishList: true, image: "o.jpg");

 Product product =Product(name: "Bites", price: 320.00, rating: 4.2, description: "Crispy Chiken", wishList: true, image: "chiken.jpg");
                    ...
                    children: <Widget>[
                      RichText(text: TextSpan(
                        children: [
                          ...
                          TextSpan(text: "\R\s" +product.price.toString() + "\n",
                      ...
                      IconButton(onPressed: null, icon: Icon(Icons.delete, color: black,))
                    ],
                  ),
                ],
              ),
